...
```{r}
numeric_signings <- current_players_preds %>%
  dplyr::select(True.Salary, Pred.Salary, True.Length, Estimate.LengthYears, Estimate.SalaryCapp)
...
```{r}
nrow(player_signing_data)
nrow(player_signing_data) / 6
801-133
134/668
```
